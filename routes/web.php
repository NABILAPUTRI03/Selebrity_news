...
Route::middleware('auth')->group(function () {
    ...
    Route::delete('/categories/{id}', [CategoriesController::class, 'destory'])->name('category.destory');

    //Profile
    Route::get('/profile', [ProfileController::class, 'edit'])->name('profile.edit');
    Route::put('/profile/{id}', [ProfileController::class, 'update'])->name('profil.edit');
});
